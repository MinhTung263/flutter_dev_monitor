...
class LocaleKeys {
  ...
  static const mapNoApiRequests = MonitorLocaleKey('mapNoApiRequests');
  static const mapNoMatchingApi = MonitorLocaleKey('mapNoMatchingApi');
  static const mapNoFlutterErrors = MonitorLocaleKey('mapNoFlutterErrors');
  static const mapSubject = MonitorLocaleKey('mapSubject');
  static const mapBack = MonitorLocaleKey('mapBack');
  static const mapSwitchGrid = MonitorLocaleKey('mapSwitchGrid');
  static const mapSwitchStream = MonitorLocaleKey('mapSwitchStream');
  static const mapSwitchCircular = MonitorLocaleKey('mapSwitchCircular');
  static const mapSwitchTree = MonitorLocaleKey('mapSwitchTree');
  static const mapRecenterCamera = MonitorLocaleKey('mapRecenterCamera');
  static const mapSearchScreen = MonitorLocaleKey('mapSearchScreen');
  static const mapExportWeb = MonitorLocaleKey('mapExportWeb');
  static const mapHideGrid = MonitorLocaleKey('mapHideGrid');
  static const mapShowGrid = MonitorLocaleKey('mapShowGrid');
  static const mapResetLayoutZoom = MonitorLocaleKey('mapResetLayoutZoom');
  static const mapExitFullScreen = MonitorLocaleKey('mapExitFullScreen');
  static const mapFullScreen = MonitorLocaleKey('mapFullScreen');
  static const mapZoomOut = MonitorLocaleKey('mapZoomOut');
  static const mapZoomIn = MonitorLocaleKey('mapZoomIn');
  static const mapSearchTitle = MonitorLocaleKey('mapSearchTitle');
  static const mapSearchHint = MonitorLocaleKey('mapSearchHint');
  static const mapSearchNotFound = MonitorLocaleKey('mapSearchNotFound');
